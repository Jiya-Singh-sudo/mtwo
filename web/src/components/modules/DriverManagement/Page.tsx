import { User, Clock, Phone, Shield } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">चालक प्रबंधन - Manage drivers, shifts, and assignments</p>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-sm">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          {drivers.map((driver) => (
            <div key={driver.id} className="border border-gray-200 rounded-sm p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`w-16 h-16 ${
                    driver.status === 'Available' ? 'bg-green-100' :
                  ...
                  <div>
                    <h4 className="text-gray-900">{driver.name}</h4>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                  <span className="text-xs text-gray-600">Experience: {driver.experience}</span>
                  <span className="text-xs text-gray-600">Rating: {driver.rating}</span>
                </div>
              </div>
      ...
      <div className="bg-white border border-gray-200 rounded-sm">
        <div className="border-b border-gray-200 px-6 py-4">
          <h3 className="text-[#00247D]">Today's Shift Schedule</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-[#D4A574] to-[#C9994E] border-b border-[#B8935C]">
              <tr>
                <th className="px-6 py-3 text-left text-sm text-[#00247D]">Driver Name</th>
                <th className="px-6 py-3 text-left text-sm text-[#00247D]">Shift Time</th>
                <th className="px-6 py-3 text-left text-sm text-[#00247D]">Vehicle</th>
                <th className="px-6 py-3 text-left text-sm text-[#00247D]">Assignment</th>
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm">08:00 - 20:00</td>
                <td className="px-6 py-4 text-sm">DL-01-AB-1234</td>
                <td className="px-6 py-4 text-sm">Shri Rajesh Kumar</td>
                <td className="px-6 py-4">
                  <span className="px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded-full">Active</span>
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
              ...
              <tr className="hover:bg-gray-50">
                <td className="px-6 py-4 text-sm">Rakesh Sharma</td>
                <td className="px-6 py-4 text-sm">20:00 - 08:00</td>
                <td className="px-6 py-4 text-sm">DL-01-XY-7890</td>
                <td className="px-6 py-4 text-sm">VVIP Standby</td>
                <td className="px-6 py-4">
                  <span className="px-3 py-1 text-xs bg-purple-100 text-purple-700 rounded-full">Night Duty</span>
                </td>
              </tr>
            </tbody>
          </table>
