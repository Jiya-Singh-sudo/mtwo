...
export class RoomManagementController {
  ...
  @Get('status-counts')
  getStatusCounts() {
    return this.service.getRoomStatusCounts();
  }
  ...
  getOverview(
    ...
    @Query('withGuest') withGuest?: string,

    @Query('withHousekeeping')
    withHousekeeping?: string,
    ...
    return this.service.getOverview({
      ...
      withGuest: withGuest === 'true' ? true : undefined,
      withHousekeeping: withHousekeeping === 'true' ? true : undefined,
