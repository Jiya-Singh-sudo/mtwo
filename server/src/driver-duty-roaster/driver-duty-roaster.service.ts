...
export class DriverDutyRoasterService {
  ...
  async create(dto: CreateDriverDutyDto) {
    ...
    const sql = `
      INSERT INTO t_driver_duty_roaster (
        ...
        sunday_duty_in_time, sunday_duty_out_time, sunday_week_off, sunday_shift,
        monday_duty_in_time, monday_duty_out_time, monday_week_off, monday_shift,
        tuesday_duty_in_time, tuesday_duty_out_time, tuesday_week_off, tuesday_shift,
        wednesday_duty_in_time, wednesday_duty_out_time, wednesday_week_off, wednesday_shift,
        thursday_duty_in_time, thursday_duty_out_time, thursday_week_off, thursday_shift,
        friday_duty_in_time, friday_duty_out_time, friday_week_off, friday_shift,
        saturday_duty_in_time, saturday_duty_out_time, saturday_week_off, saturday_shift
      )
      VALUES (
        $1,$2,
        $3,$4,$5,$6,
    ...
    const params = [
      ...
      dto.sunday_duty_in_time, dto.sunday_duty_out_time, dto.sunday_week_off, dto.sunday_shift,
      dto.monday_duty_in_time, dto.monday_duty_out_time, dto.monday_week_off, dto.monday_shift,
      dto.tuesday_duty_in_time, dto.tuesday_duty_out_time, dto.tuesday_week_off, dto.tuesday_shift,
      dto.wednesday_duty_in_time, dto.wednesday_duty_out_time, dto.wednesday_week_off, dto.wednesday_shift,
      dto.thursday_duty_in_time, dto.thursday_duty_out_time, dto.thursday_week_off, dto.thursday_shift,
      dto.friday_duty_in_time, dto.friday_duty_out_time, dto.friday_week_off, dto.friday_shift,
      dto.saturday_duty_in_time, dto.saturday_duty_out_time, dto.saturday_week_off, dto.saturday_shift,
    ];
  ...
  async update(id: string, dto: UpdateDriverDutyDto) {
    ...
    const res = await this.db.query(sql, [
      ...
      dto.sunday_shift ?? existing.sunday_shift,
      ...
      dto.monday_shift ?? existing.monday_shift,
      ...
      dto.tuesday_shift ?? existing.tuesday_shift,
      ...
      dto.wednesday_shift ?? existing.wednesday_shift,
      ...
      dto.thursday_shift ?? existing.thursday_shift,
      ...
      dto.friday_shift ?? existing.friday_shift,
      ...
      dto.saturday_shift ?? existing.saturday_shift,
