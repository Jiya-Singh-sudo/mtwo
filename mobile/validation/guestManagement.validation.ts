...
export const guestManagementSchema = z
  .object({
    ...
    status: z
      .enum(["Scheduled", "Entered", "Inside", "Exited", "Cancelled"])
      .optional(),
    purpose: z
      .string()
      ...
      .optional(),
    number_of_rooms: z.coerce.number().min(0, "Cannot be negative").default(0),
  })
...
export type GuestManagementSchema = z.infer<typeof guestManagementSchema>;
